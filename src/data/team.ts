...
export const teamMembers: TeamMember[] = [
  {
    ...
    gradient: "from-primary via-[#4a7a94] to-[#6a9ab5]",
  ...
  },
  {
    ...
    gradient: "from-[#2a4a5e] via-primary-dark to-primary",
  ...
  },
  {
    ...
    gradient: "from-[#3d6b84] to-primary-dark via-primary",
  ...
  },
  {
    ...
    gradient: "from-primary to-[#4a7a94] via-[#2a5a70]",
  ...
  },
  {
    ...
    gradient: "from-[#2a5a70] via-primary-dark to-[#4a7a94]",
